const questions = [
    ...
    {
        question: "In the proportion \( \frac{a}{b} = \frac{c}{d} \), what are the extremes?",
        answers: [
    ...
    },
    {
        ...
        question: "What are the means in the proportion \( \frac{a}{b} = \frac{c}{d} \)?",
        answers: [
    ...
    {
        question: " If \( \frac{3}{5} = \frac{x}{15} \), what is the value of 'x'?",
        answers: [
    ...
    {
        question: "Solve for 'y' in the proportion \( \frac{7}{10} = \frac{14}{y} \).",
        answers: [
        {text:"5 ", correct: false},
    ...
    {
        question: "If \( \frac{a}{2} = \frac{5}{8} \), what is the value of 'a'?",
        answers: [
    ...
    {
        question: "  In the proportion \( \frac{3}{5} = \frac{x}{10} \), what is the value of 'x'?",
        answers: [
    ...
    {
        question: "If \( \frac{x}{3} = \frac{15}{9} \), what is the value of 'x'?",
        answers: [
        {text: " 5   ", correct: true},
    ...
    {
        question: "What is the fourth term (d) in the proportion \( \frac{2}{3} = \frac{4}{d} \)?",
        answers: [
    ...
    {
        question: "  In the proportion \( \frac{4}{7} = \frac{12}{21} \), what are the means?",
        answers: [
